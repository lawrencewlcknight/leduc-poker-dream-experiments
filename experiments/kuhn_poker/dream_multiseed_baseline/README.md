...
This experiment trains a DREAM-style OpenSpiel implementation on Kuhn poker using a fixed multi-seed protocol. It is intended to sit alongside the Deep CFR and ESCHER baseline experiments in the thesis.
