"""Run the DREAM factorised advantage-head ablation."""
...
from .config import EXPERIMENT_CONFIG, FACTORISED_ADVANTAGE_HEAD_VARIANTS
...
def variants_from_args(args: argparse.Namespace) -> list[Dict]:
    variants = copy.deepcopy(FACTORISED_ADVANTAGE_HEAD_VARIANTS)
