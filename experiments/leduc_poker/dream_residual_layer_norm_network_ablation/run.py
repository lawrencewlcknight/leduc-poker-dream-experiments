"""Run the DREAM residual-LayerNorm network ablation."""
...
from .config import EXPERIMENT_CONFIG, RESIDUAL_LAYER_NORM_NETWORK_VARIANTS
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Comma-separated variant ids to run; defaults to this experiment's configured variants.",
    )
    return parser.parse_args()


def variants_from_args(args: argparse.Namespace) -> list[Dict]:
    variants = copy.deepcopy(RESIDUAL_LAYER_NORM_NETWORK_VARIANTS)
