...
This experiment tests whether combining residual hidden blocks with LayerNorm
improves DREAM optimisation in Leduc poker. It compares the baseline
`plain_layers2_width32` variant with residual-LayerNorm DREAM networks at
hidden depths `2`, `4`, and `8`, all at width `32`.

The treatment is applied consistently to the average-policy, advantage, and
