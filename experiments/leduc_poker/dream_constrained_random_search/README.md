...
This experiment tests whether DREAM performance in Leduc poker can be improved by tuning solver parameters while keeping the OpenSpiel DREAM-style implementation fixed.
