"""Run the DREAM average-strategy weighting ablation."""
...
TREATMENT_KEYS = [
    ...
    "average_strategy_importance_correction",
]
...
def run_experiment(
    config: Dict,
    variants: Sequence[Dict] = AVERAGE_STRATEGY_WEIGHTING_VARIANTS,
    ...
    create_variant_ablation_plots(
        ...
        variants,
        output_dir,
        plot_prefix="dream_average_strategy_weighting",
        title_prefix="DREAM Average-Strategy Weighting Ablation",
        diagnostic_metrics=[
            ("policy_loss", "Average-Policy Loss", "Policy loss"),
            ("policy_entropy_mean", "Average-Policy Entropy", "Policy entropy"),
            ("strategy_buffer_size", "Strategy Buffer Size", "Samples"),
...
def variants_from_args(args: argparse.Namespace) -> list[Dict]:
    variants = copy.deepcopy(AVERAGE_STRATEGY_WEIGHTING_VARIANTS)
