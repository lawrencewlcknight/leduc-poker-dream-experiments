...
This experiment tests how the number of outcome-sampling trajectories per DREAM iteration affects exploitability, stability, and sample efficiency in Leduc poker.
