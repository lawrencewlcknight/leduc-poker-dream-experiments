"""Run the DREAM role-specific network-capacity ablation."""
...
from .config import EXPERIMENT_CONFIG, ROLE_SPECIFIC_CAPACITY_VARIANTS
...
def variants_from_args(args: argparse.Namespace) -> list[Dict]:
    variants = copy.deepcopy(ROLE_SPECIFIC_CAPACITY_VARIANTS)
