"""Run the DREAM architecture-candidate comparison."""
...
from .config import ARCHITECTURE_CANDIDATE_VARIANTS, EXPERIMENT_CONFIG
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Comma-separated variant ids to run; defaults to baseline and candidate.",
    )
    return parser.parse_args()


def variants_from_args(args: argparse.Namespace) -> list[Dict]:
    variants = copy.deepcopy(ARCHITECTURE_CANDIDATE_VARIANTS)
