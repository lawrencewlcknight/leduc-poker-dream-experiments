from experiments.leduc_poker.dream_candidate_900_traversal_baseline1000_long_node.config import (
...
def test_900_traversal_baseline1000_long_node_config_matches_request():
...
def test_900_traversal_baseline1000_long_node_variant_is_single_arm():
    variants = EXPERIMENT_CONFIG["ablation_variants"]

    assert len(variants) == 1
    assert variants[0]["variant_id"] == CANDIDATE_900_BASELINE1000_VARIANT
    ...
    assert EXPERIMENT_CONFIG["baseline_variant"] == CANDIDATE_900_BASELINE1000_VARIANT
